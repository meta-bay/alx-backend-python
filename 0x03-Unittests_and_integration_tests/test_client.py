...
class TestGithubOrgClient(unittest.TestCase):
    ...
    def test_org(self, org: str, resp: Dict, mocked_fn: MagicMock) -> None:
        ...
        self.assertEqual(git_org_client.org(), resp)
    ...
    def test_has_license(self, repo: Dict, key: str, expected: bool) -> None:
        ...
        client_has_licence = git_org_client.has_license(repo, key)
...
class TestIntegrationGithubOrgClient(unittest.TestCase):
    """
    Class to do integration tests for the GithubOrgClient class.
    """
    @classmethod
